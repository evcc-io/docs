...
<div style="text-align: center; margin: 1.5rem 0;">
  <LinkButton href="/en/installation" icon="rocket" iconPlacement="start">
    Install evcc now
  </LinkButton>
</div>
...
- [REST](/en/integrations/rest-api) & [MQTT](/en/integrations/mqtt-api) APIs for integration into other home automation systems (such as [Home Assistant](/en/integrations/home-assistant))
