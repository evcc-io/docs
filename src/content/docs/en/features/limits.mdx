---
title: "Minimum Charge & Limits"
description: "With the minimum charge your vehicle is topped up right after plugging in, and with the charging limit it never charges beyond a level such as 80%."
sidebar:
  order: 4
---
...
<Screenshot
  ...
  caption="Screenshot of the minimum charge setting in the vehicle settings dialog"
/>
...
If the measured temperature is below this value, battery and grid power are also used in smart mode to maintain this temperature.
...
You can, however, set a **Default limit** per vehicle in the **Vehicle Settings** dialog (**More → Vehicles**).
...
<Screenshot
  ...
  caption="Screenshot of the default limit setting in the vehicle settings dialog"
/>
