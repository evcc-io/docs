...
description: "Shows how to set up a fixed, time-based or dynamic electricity tariff such as Tibber or Awattar and let evcc charge from the grid in the cheapest hours."
sidebar:
  order: 3
---
...
<Screenshot
  ...
  caption="Screenshot of the charging plan dialog with price-optimised charging"
/>
