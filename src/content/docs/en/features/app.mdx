...
description: "The official evcc app for iOS, Android and macOS finds your instance automatically, works together with remote access and can be opened via evcc:// links."
sidebar:
  order: 10
---
