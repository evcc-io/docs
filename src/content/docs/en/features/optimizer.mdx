---
title: "Optimizer 🧪"
description: "The experimental optimizer uses forecasts and your consumption history to work out cost-optimal charging and battery decisions, currently for information only."
sidebar:
  order: 13
---
...
- **Forecast data:** [Solar yield](/en/tariffs#solar), [electricity prices](/en/tariffs#price), [feed-in tariffs](/en/features/dynamic-feedin), [outdoor temperature](/en/tariffs#temperature) to predict heating demand
...
The optimizer requires an active [sponsorship](/en/sponsorship).
