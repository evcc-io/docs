...
Battery boost supports **Solar** and **Min+Solar** mode with power from the home storage.
...
Select a **Battery Boost** limit in the settings of the charging point.
Fast charging from the home battery is then allowed until it is drained to this level.
...
A boost button appears at the charging point, which you can use to start and stop boosting for the current charging session.
