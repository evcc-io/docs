---
title: "CO₂-Optimized Charging"
description: "Shows how to charge from the grid when its CO₂ intensity is low by adding a CO₂ forecast such as Grünstromindex and setting a CO₂ limit at the charging point."
sidebar:
  order: 2
---
...
Each bar represents a 15-minute slot.
...
This limit applies in **Smart** mode of the current charging point.
...
<Screenshot
  ...
  caption="Screenshot of the charging plan dialog with optimised CO₂ charging"
/>
