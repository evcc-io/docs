---
title: "Dynamic Feed-In"
description: "With a dynamic feed-in tariff, evcc can pause or reduce charging while feed-in prices are high so that your solar power earns more in the grid."
sidebar:
  order: 4
---
...
With the _Feed-in priority_ feature, you can set a price threshold per charging point.
When the feed-in tariffs are high (shown as orange bars), charging is paused (**Smart** mode) or reduced to a minimum (**Always charge**).
