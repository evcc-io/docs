...
description: "Explains which values evcc shows while charging, how the session history with statistics and CSV export works and what the details of a single session contain."
sidebar:
  order: 7
---
...
The data is presented in tabular form and can be exported as a CSV or Excel file.
