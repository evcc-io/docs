---
title: "Vehicles"
description: "Explains what the guest vehicle, offline vehicles and vehicles with an online API can do in evcc and how several vehicles share one wallbox."
sidebar:
  order: 8
---
