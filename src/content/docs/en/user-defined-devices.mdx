...
- `curtail` and `curtailed` are used together for solar meters that support feed-in curtailment according to § 9 EEG.
...
| `curtailed`    | `int`                 | no       | `pv`          | Current feed-in limit in % (0 to 100). `100` = uncurtailed. |
...
| `curtail`     | `int` | no       | `pv`      | Set feed-in limit in % (0 to 100). `100` = uncurtailed.                                                                                                           |
