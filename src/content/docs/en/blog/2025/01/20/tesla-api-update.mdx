...
description: "Release notes for evcc 0.133 from January 2025: the Tesla Fleet API becomes paid, so you need your own Tesla Developer Account and tesla.evcc.io is shut down."
authors: [naltatis]
tags: [release]
prev: false
next: false
...
:::caution[The proxy token is very powerful.]
