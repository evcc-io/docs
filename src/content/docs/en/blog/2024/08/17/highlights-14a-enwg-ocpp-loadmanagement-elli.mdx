...
description: "Release highlights for evcc 0.130 from August 2024 with load management and § 14a EnWG dimming, grid charging for the home battery and OCPP progress."
authors: [naltatis]
...
You can find more information in the [documentation](/en/features/loadmanagement).
...
This is an experimental feature and is available if your inverter supports active battery control ([see documentation](/en/meters)) and you have a dynamic electricity tariff.
...
This now also enables [vehicle recognition via RFID](/en/features/vehicle#detection-via-rfid).
...
We've successfully tested the implementation with a variety of devices and added them to the [documentation](/en/chargers).
