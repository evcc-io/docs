...
description: "Feature highlights from November 2024 with charts for your charging sessions, the experimental battery boost, flexible tariffs and hybrid inverters."
authors: [naltatis]
...
The overview of [charging sessions](/en/features/sessions) has been available for a while.
...
In the [documentation](/en/features/co2) you can find out how to set up the required [CO₂ data sources](/en/features/co2) and [dynamic prices](/en/features/dynamic-prices).

![Visualization of costs](./ipad-stats-per-vehicle.webp)

## Battery Boost

The first version of the often requested [Battery Boost](/en/features/battery#battery-boost) has made it into the release as an experimental feature 🧪.
...
The list of [different tariffs](/en/tariffs) is growing steadily.
...
All affected [inverter templates](/en/meters) (e.g. Fronius, Growatt, SMA, Sungrow, ...) now have the extended option `maxAcPower`.
