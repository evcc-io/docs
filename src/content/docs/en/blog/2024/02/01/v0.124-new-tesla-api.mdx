...
description: "Release notes for evcc 0.124 from February 2024 with the new official Tesla API integration via tesla.evcc.io and active control of the home battery."
authors: [naltatis]
tags: [release]
prev: false
next: false
...
In the documentation you can now see [if your inverter is supported](/en/meters#features).
...
Last year we introduced a [configuration dialog](/en/blog/2023/10/05/feature-highlights-10-2023#battery-settings) where you can set the priority between vehicle and house battery charging.
...
This lock is also active during [scheduled charging](/en/blog/2023/10/05/feature-highlights-10-2023#charging-planner-visualization) and [smart grid charging](/en/blog/2023/10/05/feature-highlights-10-2023#smart-grid-charging).
