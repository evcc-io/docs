...
description: "Release highlights for evcc 0.300 from January 2026: browser-based configuration is production ready, plus Linux images and 15-minute price forecasts."
authors: [naltatis]
...
More details about the migration process can be found in the [FAQ](/en/faq#ui-migration).
