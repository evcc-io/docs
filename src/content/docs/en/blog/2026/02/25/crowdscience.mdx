...
description: "In February 2026 HTW Berlin launched evcc-Crowdscience, a platform where evcc users anonymously share real charging data via MQTT for research."
authors: [naltatis]
