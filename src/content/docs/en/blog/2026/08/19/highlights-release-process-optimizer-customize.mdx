...
description: "Release highlights for evcc 0.314 from August 2026 with the new release process, optimizer progress, config UI improvements and interface customisation."
authors: [naltatis]
