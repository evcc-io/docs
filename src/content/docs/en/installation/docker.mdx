---
title: "Docker"
description: "Run evcc as a Docker container, e.g. on a Synology, QNAP, Unraid or TrueNAS NAS, with a docker compose example and notes on configuration and testing."
sidebar:
  order: 4
---
...
```
  ...
  <TabItem label="SMA Devices and EEBus">
