---
title: "FreeBSD"
description: "Install evcc on FreeBSD from the official package, enable it as a service, keep it updated and optionally put nginx in front of it as a reverse proxy."
sidebar:
  order: 9
---
