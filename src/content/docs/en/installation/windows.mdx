---
title: "Windows"
description: "Install evcc on Windows by hand, run it from the command prompt or as a background service and update or downgrade it later."
sidebar:
  order: 10
---
...
- Go through the tabs of the dialog.
  ...
  - **Application**:
    ...
    - _Arguments_: Parameters for evcc, e.g. `-c evcc.yaml`.
      ...
      This is relevant when [resetting the password](/en/faq#password-reset).
