---
title: "Proxmox"
description: "A community guide for running evcc in a lightweight LXC container on Proxmox, either set up by hand from an Ubuntu template or via the community helper script."
sidebar:
  order: 6
---
