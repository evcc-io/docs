...
description: "Gives an overview of all ways to install evcc, from the ready-made Raspberry Pi image to Docker, Home Assistant, Proxmox, Linux, macOS, FreeBSD and Windows."
