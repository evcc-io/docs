...
description: "Install evcc as a Home Assistant app without any command line work and learn where its configuration lives, how updates work and a few advanced tips."
sidebar:
  order: 5
---
