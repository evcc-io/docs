---
title: "Configuration"
description: "Shows how to set up evcc after installation, preferably in the web interface or alternatively with an evcc.yaml file, and how to test and troubleshoot it."
sidebar:
  order: 11
---
