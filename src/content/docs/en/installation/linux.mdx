---
title: "Linux"
description: "Install evcc from the apt repository on Debian, Ubuntu and similar distributions, run it as a systemd service and keep it updated or roll back."
sidebar:
  order: 7
---
