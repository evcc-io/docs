---
title: "Sponsorship"
description: "Explains why some wallboxes need a sponsor token, how to get one via GitHub Sponsors or direct payment, and how to test everything first with the trial token."
sidebar:
  order: 9
---
