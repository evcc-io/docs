...
description: "Shows how to connect evcc and Home Assistant, ideally with the ha-evcc integration or manually via REST API and MQTT, to visualise data and automate charging."
sidebar:
  order: 3
---
