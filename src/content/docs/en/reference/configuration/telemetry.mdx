---
title: "telemetry"
description: "How to enable telemetry in evcc.yaml to share aggregated charging data such as power, energy and solar share with evcc.io, available to sponsors."
sidebar:
  order: 17
---
