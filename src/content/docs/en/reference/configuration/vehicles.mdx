---
title: "vehicles"
description: "How to define vehicles in evcc.yaml: battery capacity, phases, cache time, RFID or vehicle identifiers for automatic detection and the display icon."
sidebar:
  order: 7
---
