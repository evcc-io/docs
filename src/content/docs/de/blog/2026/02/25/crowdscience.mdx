...
description: "Im Februar 2026 hat die HTW Berlin evcc-Crowdscience gestartet, eine Plattform, auf der evcc-Nutzer echte Ladedaten anonym per MQTT für die Forschung teilen."
authors: [naltatis]
