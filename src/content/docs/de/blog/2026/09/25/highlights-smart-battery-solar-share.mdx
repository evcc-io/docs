...
## Neue Modi: Smart und Dauerhaft laden
...
Aus **PV** wird **Smart**.
Er deckt PV-Überschuss, dynamische Tarife und Ladepläne ab und ist der Modus, in dem der kommende Optimizer arbeiten wird.
...
Die Beschriftung der Modi passt sich dem Gerät an: Eine Wallbox zeigt **Aus / Smart / Schnell**, ein schaltbares Gerät **Aus / Smart / An**, eine Wärmepumpe **Normal / Smart / Boost**.
Die Details erklärt die [Seite zum PV-Überschussladen](/de/features/solar-charging#always-charge).
