...
description: "Im März 2025 ist die erste evcc App für iOS und Android erschienen, mit automatischer Erkennung deiner Instanz, Vollbild-Oberfläche und Offline-Erkennung."
authors: [naltatis]
tags: [app]
prev: false
next: false
