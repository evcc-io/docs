...
description: "Release Notes zu evcc 0.133 vom Januar 2025: Die Tesla Fleet API wird kostenpflichtig, du brauchst einen eigenen Tesla Developer Account."
authors: [naltatis]
tags: [release]
prev: false
next: false
...
:::caution[Das Proxy-Token ist sehr mächtig.]
