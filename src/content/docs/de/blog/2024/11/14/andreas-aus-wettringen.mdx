...
description: "Community-Portrait vom November 2024: Apotheker Andreas aus Wettringen erzählt von seinem Mini SE, Wallbox-Debugging und seiner Hausautomation."
...
Zwei Monate später wurde dann die 10kWp PV Anlage installiert.
...
4.500 kWh ins Netz gespeist habe.
...
Um bei einem Stromausfall wenigstens das eine oder andere Gerät weiter betreiben zu können habe ich mir eine EcoFlow DELTA Pro mit Zusatzakku, zusammen 7,2 kWh Speicher, angeschafft.
...
| **Solaranlage**    | 10 kWp (4,6 kWp Ost, 5,4 kWp West)   |
