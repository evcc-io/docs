...
description: "Release Notes zu evcc 0.124 vom Februar 2024 mit der neuen offiziellen Tesla-API-Integration über tesla.evcc.io und der aktiven Steuerung der Hausbatterie."
authors: [naltatis]
tags: [release]
prev: false
next: false
