...
| `batterymode` | `int` | nein      | `battery` | Setze Lademodus direkt (1: normal, 2: hold, 3: charge, 4: holdcharge, 5: discharge)                                                                             |
...
Ist `batterymode` ein [`switch`](/de/reference/plugins#switch) (optional in einem `watchdog`), werden die unterstützten Modi aus dessen `case`-Werten übernommen.
