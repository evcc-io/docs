...
- `curtail` und `curtailed` werden gemeinsam für PV-Zähler verwendet, die eine Einspeisebegrenzung nach § 9 EEG unterstützen.
...
| `curtailed`    | `int`                 | nein      | `pv`          | Aktuelle Einspeisebegrenzung in % (0 bis 100). `100` = nicht abgeregelt.    |
...
| `curtail`     | `int` | nein      | `pv`      | Setze Einspeisebegrenzung in % (0 bis 100). `100` = nicht abgeregelt.                                                                                 |
