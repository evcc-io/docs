...
Einige Geräte, wie z.b. Zähler ([`meters`](/de/reference/configuration/meters#modbus)) oder Wallboxen ([`chargers`](/de/reference/configuration/chargers)) werden über das Modbus-Protokoll angebunden und angesprochen.
