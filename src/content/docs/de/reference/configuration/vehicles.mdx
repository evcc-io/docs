---
title: "vehicles"
description: "Fahrzeuge in der evcc.yaml anlegen: Batteriekapazität, Phasen, RFID- oder Fahrzeugkennungen zur automatischen Erkennung und das angezeigte Symbol."
sidebar:
  order: 7
---
...
Konfigurationen für bekannte Fahrzeuge sind unter [Geräte - Fahrzeuge](/de/vehicles) zu finden.
...
Durch Konfiguration des Parameters `phases` am Fahrzeug kann `evcc` im Smart-Modus den Ladevorgang bereits bei geringerer verfügbarer Leistung beginnen.
