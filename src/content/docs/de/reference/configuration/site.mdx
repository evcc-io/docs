---
title: "site"
description: "So beschreibst du deine Hausinstallation in der evcc.yaml: Netz-, PV- und Batteriezähler zuordnen und die Überschussregelung mit residualPower abstimmen."
sidebar:
  order: 2
---
...
Soll im Smart-Modus ein Netzbezugsanteil verbleiben bzw. zugelassen werden, muss hier eine negative Leistung entsprechend des Maximalanteils des Netzbezugs konfiguriert werden.
...
Die Ladung soll im Smart-Modus mit mindestens 6A (einphasig) auch bereits mit nur 50% PV-Anteil beginnen (Rest Netzbezug)
