---
title: "MCP-Server"
description: "Der experimentelle MCP-Server lässt KI-Assistenten wie Claude, Gemini oder ChatGPT deine evcc-Instanz auslesen und steuern, Schritt für Schritt gezeigt mit Claude Code."
...
import mcpVideo from "@assets/integrations/mcp-integration.mp4?url";
import mcpPosterImg from "@assets/integrations/mcp-integration.webp";
export const mcpPoster = mcpPosterImg.src;
...
Der MCP-Server wird beim Start aktiviert, wenn experimentelle Funktionen eingeschaltet sind.
...
4. Stelle sicher, dass deine evcc-Instanz mit dem MCP-Server läuft, indem du die MCP-Karte in der UI-Konfiguration prüfst.
...
Dies funktioniert allerdings nur, wenn du eine [PV-Vorhersage](/de/tariffs#pv-vorhersage) konfiguriert hast.
