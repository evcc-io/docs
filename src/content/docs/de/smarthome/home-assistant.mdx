...
description: "Zeigt, wie du evcc mit Home Assistant verbindest, am besten über die Integration ha-evcc oder manuell per REST-API und MQTT, für Dashboards und Automationen."
sidebar:
  order: 3
---
