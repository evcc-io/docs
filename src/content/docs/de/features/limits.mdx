---
title: "Mindestladung & Ladelimit"
description: "Mit der Mindestladung wird dein Fahrzeug direkt nach dem Anstecken aufgeladen, und mit dem Ladelimit lädt es nie über eine Grenze wie 80% hinaus."
sidebar:
  order: 4
---
...
Die Einstellung **Minimale Ladung** findest du im Dialog **Fahrzeugeinstellungen**, den du über **Mehr → Fahrzeuge** in der Navigationsleiste öffnest.

<Screenshot
  name="features/screenshots/minsoc-setting"
  caption="Screenshot der Einstellung Minimale Ladung in den Fahrzeugeinstellungen"
/>
...
Liegt die gemessene Temperatur unter diesem Wert, wird im Smart-Modus auch mit Batterie- und Netzstrom geheizt, um diese Temperatur zu halten.
...
Du kannst allerdings ein **Standardlimit** pro Fahrzeug im Dialog **Fahrzeugeinstellungen** (**Mehr → Fahrzeuge**) festlegen.
...
<Screenshot
  ...
  caption="Screenshot der Einstellung Standardlimit in den Fahrzeugeinstellungen"
/>
