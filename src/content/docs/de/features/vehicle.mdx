---
title: "Fahrzeuge"
description: "Erklärt, was Gastfahrzeug, Offline-Fahrzeuge und Fahrzeuge mit Online-API in evcc können, wie sich mehrere Fahrzeuge eine Wallbox teilen und wie die Klimatisierung läuft."
sidebar:
  order: 8
---
