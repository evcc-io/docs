---
title: "Ladepläne"
description: "Mit einem Ladeplan gibst du Abfahrtszeit und Ladeziel vor, und evcc wählt davor die günstigsten oder grünsten Stunden aus, auf Wunsch jede Woche wiederkehrend."
sidebar:
  order: 5
---
...
Der Planer ist nur im **Smart**-Modus aktiv.
...
Über den Einstellungsbutton neben der Planvorschau kannst du die Ladestrategie anpassen.

Die Einstellung **Optimierung** bestimmt, wie die Ladezeiten gewählt werden:
_günstigst_ wählt die günstigsten Stunden, was zu mehreren Starts und Stopps führen kann, während _kontinuierlich_ in einem durchgehenden Block rechtzeitig zur Abfahrt lädt.

## Spätes Laden

Mit der Option **Spätes Laden** kannst du festlegen, dass ein Teil der geplanten Ladung auf kurz vor die Abfahrt verschoben wird.
...
Der Spät-Anteil kann individuell festgelegt werden, von 15 Minuten bis 2 Stunden oder auf _alles_.
