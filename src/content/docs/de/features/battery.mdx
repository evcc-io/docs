...
Wähle in den Einstellungen des Ladepunktes ein **Batterie Boost**-Limit.
Schnellladen aus der Hausbatterie ist dann erlaubt, bis sie auf diesen Stand entladen ist.
...
Am Ladepunkt erscheint ein Boost-Button, mit dem du den Boost für den aktuellen Ladevorgang starten und stoppen kannst.
