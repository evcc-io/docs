...
description: "Zeigt, wie du einen festen, zeitabhängigen oder dynamischen Stromtarif wie Tibber oder Awattar einrichtest und evcc in den günstigsten Stunden aus dem Netz laden lässt."
sidebar:
  order: 3
---
