---
title: "Optimizer 🧪"
description: "Der experimentelle Optimizer nutzt Prognosen und deine Verbrauchshistorie, um kostenoptimale Lade- und Batterieentscheidungen zu berechnen, derzeit nur zur Information."
sidebar:
  order: 13
---
...
- **Prognosedaten:** [PV-Ertrag](/de/tariffs#solar), [Strompreise](/de/tariffs#price), [Einspeisetarife](/de/features/dynamic-feedin), [Außentemperatur](/de/tariffs#temperature) für die Prognose des Heizbedarfs
...
Der Optimizer erfordert ein aktives [Sponsoring](/de/sponsorship).
...
- **Menü → Optimizer:** Diagramme, die zeigen, wie sich Hausbatterie und Ladepunkte in den nächsten Stunden verhalten sollen und wie die zu erwartenden Energiekosten im Optimierungszeitraum sein werden (siehe Screenshot unten).
