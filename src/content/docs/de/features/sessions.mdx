---
title: "Ladevorgänge"
description: "Erklärt, welche Werte evcc beim Laden anzeigt, wie die Liste der Ladevorgänge mit Statistiken und CSV-Export funktioniert und was die Details eines Ladevorgangs zeigen."
sidebar:
  order: 7
---
...
Die Daten sind tabellarisch aufbereitet und können als CSV- oder Excel-Datei exportiert werden.
