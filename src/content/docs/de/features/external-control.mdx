---
title: "Externe Steuerung (§14a EnWG & §9 EEG)"
sidebar:
  label: "Externe Steuerung (§14a, §9)"
  order: 10
---
...
Diese Funktion wird weiter ausgebaut und entsprechende Zähler werden in der [Gerätedokumentation](/de/meters) markiert.
:::
