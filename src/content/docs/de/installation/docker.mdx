---
title: "Docker"
description: "Betreibe evcc als Docker-Container, z. B. auf einem NAS von Synology, QNAP, Unraid oder TrueNAS, mit einem docker-compose-Beispiel und Hinweisen zum Testen."
sidebar:
  order: 4
---
...
```
  ...
  <TabItem label="SMA Geräte und EEBus">
