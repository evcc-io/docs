---
title: "macOS"
description: "Installiere evcc auf macOS mit Homebrew, starte es als Dienst und halte es aktuell, oder installiere es manuell, wenn du eine Nightly-Version ausprobieren möchtest."
sidebar:
  order: 8
---
