...
description: "Gibt einen Überblick über alle Wege, evcc zu installieren, vom fertigen Raspberry-Pi-Image über Docker, Home Assistant und Proxmox bis zu Linux, macOS und Windows."
