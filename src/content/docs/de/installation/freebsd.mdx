---
title: "FreeBSD"
description: "Installiere evcc auf FreeBSD aus dem offiziellen Paket, richte es als Dienst ein, halte es aktuell und stelle optional nginx als Reverse Proxy davor."
sidebar:
  order: 9
---
