...
description: "Installiere evcc als Home-Assistant-App ganz ohne Kommandozeile und erfahre, wo die Konfiguration liegt, wie Updates laufen und welche Tipps es für Fortgeschrittene gibt."
sidebar:
  order: 5
---
