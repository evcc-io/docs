...
description: "Wenn PV-Überschussladen neu für dich ist, erfährst du hier, warum evcc einen Netzzähler braucht, auf welcher Hardware es gut läuft und worauf es bei der Wallbox ankommt."
sidebar:
  hidden: true
---
...
Solltest du dazu nichts beitragen können, kannst du das Projekt durch [Sponsoring](/de/sponsorship) unterstützen.
...
Vor dem Start der Installation von evcc unter Debian oder Ubuntu gemäß der [Anleitung](/de/installation/linux) sollten alle benötigten IP-Adressen von Zählern, Solaranlagen, Speichern und Wallboxen bereitliegen.
...
Unter [Geräte > Wallboxen](/de/chargers) findest du eine Liste der aktuell unterstützten Wallboxen.
...
Unter [Funktionen > PV-Überschussladen](/de/features/solar-charging) findest du weitere Informationen.
...
Wallboxen, welche diese Funktion unterstützen, sind in der [Aufstellung](/de/chargers) entsprechend vermerkt.
