---
title: "Linux"
description: "Installiere evcc aus dem apt-Repository auf Debian, Ubuntu und ähnlichen Distributionen, betreibe es als systemd-Dienst und halte es aktuell oder gehe zurück."
sidebar:
  order: 7
---
...
1. ### Installieren
   ...
   Öffne ein Terminal und installiere die benötigten Abhängigkeiten:
   ...
   :::note
   Sollte eine serielle Schnittstelle verwendet werden, muss eventuell `sudo usermod -a -G plugdev evcc` ausgeführt werden. Das fügt den Benutzer evcc zur Gruppe plugdev hinzu und erlaubt Zugriff auf Plug-in-Geräte (USB, serielle Schnittstelle usw.) ohne Root-Rechte.
   :::
...
Wir bedanken uns bei [Cloudsmith](https://cloudsmith.com) für das Hosting des Repositories!
