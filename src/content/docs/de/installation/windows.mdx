---
title: "Windows"
description: "Installiere evcc unter Windows von Hand, starte es über die Eingabeaufforderung oder als Hintergrunddienst und spiele später Updates oder eine ältere Version ein."
sidebar:
  order: 10
---
...
- Gehe die Reiter des Dialogs durch.
  ...
  - **Application**:
    ...
    - _Arguments_: Parameter für evcc, z. B. `-c evcc.yaml`.
      ...
      Das ist relevant beim [Passwort zurücksetzen](/de/faq#password-reset).
