...
Integration of heat generators was possible through methods like [relays, smart plugs](/docs/devices/smartswitches#heat-generation) and the plugin interface ([example](https://github.com/naltatis/aton-ctrl)), and was being used.
