...
For the setup in evcc you need four pieces of information:

- **Client ID:** from the [Tesla Developer Portal](https://developer.tesla.com/)
- **Client Secret:** from the [Tesla Developer Portal](https://developer.tesla.com/)
...
vehicles:
  - type: template
    ...
    clientSecret: aaaaaa-11111-... # from developer.tesla.com
