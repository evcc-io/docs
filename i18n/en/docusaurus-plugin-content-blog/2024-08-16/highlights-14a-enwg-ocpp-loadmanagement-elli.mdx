...
Als finanzielle Firmensponsoren konnten wir [CUBOS](https://www.cubos.com), ein Unternehmen aus dem Bereich Photovoltaik und gewerbliche Ladeinfrastruktur, [lekker Energie](https://www.lekker.de), ein Energieversorger aus Berlin und die Firma [Victron Energy](https://www.victronenergy.com), ein Hersteller von offenen, modularen Wechselrichter-, Batterie- und Ladesystemen, gewinnen.
