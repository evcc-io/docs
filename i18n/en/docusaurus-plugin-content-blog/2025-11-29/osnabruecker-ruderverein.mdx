...
[![Michael and Markus with sculls](./orv-skulls.webp)](/en/blog/2025/11/29/osnabruecker-ruderverein)
...
A large boathouse roof: that's just begging for solar panels.
...
But legally we're not allowed to install more, and technically we're already maxing out the connection, at least theoretically.
If regulations change accordingly, we'd like to expand the system ourselves through volunteer work.
...
**Michael (ORV):** Our first chairman controlled his home solar system with evcc quite quickly, the initial experiences were positive.
...
Additionally, we massively expanded our network last year to have a stable and future-oriented system.

![Michael with Sungrow inverter and battery](./orv-sungrow-speicher.webp)

**Michael (evcc):** How many people shower on a typical day with your solar heating element?
Has the water ever been too cold?

**Michael (ORV):** Hard to say how many people shower per day.
Since we installed water-saving heads and timers, they definitely shower for less time.
That benefits the gas savings.
...
**Michael (evcc):** Can you already say how much gas has been saved through the heating elements?
...
That should correspond to roughly the same amount of gas.
...
Since the heating elements were commissioned, however, it's not so abundant that it would be worthwhile for significant battery charging at present.
We've already planned for wallboxes though.
...
![Michael carrying rowing boat](./orv-ruderboot.webp)
...
**Michael (evcc):** Those are good suggestions.
