...
We value a simple user experience while also offering a high degree of flexibility for advanced users.
...
The same applies to simple switch-stocks and devices with custom plugins.
...
#### Can I sponsor without a GitHub account or credit card?

Yes, a one-time sponsorship via PayPal is also possible, although not yet automated.
[Contact us](mailto:info@evcc.io) for that.
