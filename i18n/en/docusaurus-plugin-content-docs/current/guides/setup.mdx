...
Have a look at the [How does Solar mode work - a look into the innards](./solar-mode) guide for an explanation of the parameters defining the behavior of the `Solar` mode.
