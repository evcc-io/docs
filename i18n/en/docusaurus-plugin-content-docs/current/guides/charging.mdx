...
Have a look at the [How does Solar mode work - a look into the innards](./solar-mode) guide for an in-depth explanation of how solar mode works and the parameters defining its behavior.
