...
<DeviceConfig
  code={`vehicles:
    - name: my_car
      ...
      title: # Title, Will be displayed in the user interface (optional)
      capacity: 50 # Battery capacity (kWh), optional
      clientid: # FordConnect Query Client ID, Setup at https://developer.ford.com/apis/fordconnect-query
      clientsecret: # FordConnect Query Client Secret, Setup at https://developer.ford.com/apis/fordconnect-query
      redirecturi: # FordConnect Query Redirect URL, Setup at https://developer.ford.com/apis/fordconnect-query
