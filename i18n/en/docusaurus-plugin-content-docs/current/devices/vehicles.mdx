...
vehicles:
  - name: my_car
    ...
    accessToken: # See https://docs.evcc.io/en/docs/devices/vehicles#ford-connect
    refreshToken: # See https://docs.evcc.io/en/docs/devices/vehicles#ford-connect
...
vehicles:
  - name: my_car
    ...
    user: # User account (e.g. email address, user id, etc.)
    region: EMEA
    accessToken: # See https://docs.evcc.io/en/docs/devices/vehicles#mercedes
    refreshToken: # See https://docs.evcc.io/en/docs/devices/vehicles#mercedes
    vin: V... # Required if you own multiple vehicles of the same brand (optional)
    capacity: 50 # Battery capacity in kWh (optional) 
```
