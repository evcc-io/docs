...
When a [§ 14a EnWG reduction signal](/docs/features/14a-enwg-steuve) is active, the heat pump is automatically set to **reduced operation**.
This is done via the SG-ready interface and contributes to grid stability.
