...
Since heat pumps run their own heating logic independent of evcc, the UI shows two states:
...
Preconfigured heat pump types and matching templates already set the required [feature flags](./plugins#charger-feature-combinations).
For custom configurations via `type: custom`, set the matching combination of `integrateddevice`, `heating`, `continuous` and optionally `switchdevice`.
...
<DeviceConfig
  ...
  advanced={`chargers:
    - name: my_heating
      ...
      powersource: hpcurrpower # Power source, [hpcurrpower, hppower] (optional)
      tempsource: # Temperature source, [warmwater] (optional)
      sg1: hpin1opt # SG1 input, [hpin1opt, hpin2opt, hpin3opt, hpin4opt] (optional)
      sg4: hpin4opt # SG4 input, [hpin1opt, hpin2opt, hpin3opt, hpin4opt] (optional)
      value_normal_sg4: 0xxxxxxxxxxx # Bitmask for SG4 in normal mode, optional
      value_normal_sg1: 0xxxxxxxxxxxxxx # Bitmask for SG1 in normal mode, optional
      value_boost_sg4: 1xxxxxxxxxxx # Bitmask for SG4 in boost mode, optional
      value_boost_sg1: # Bitmask for SG1 in boost mode, optional
      value_dim_sg1: 1xxxxxxxxxxxxxx # Bitmask for SG1 in dim mode, optional
      value_dim_sg4: 0xxxxxxxxxxx # Bitmask for SG4 in dim mode, optional`}
/>
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/heating  -->
...
<DeviceConfig
  code={`chargers:
    - name: my_heating
      ...
      realm: germany # Region, [albania, austria, belgium, bosnia, bulgaria, croatia, cyprus, czechrepublic, denmark, estonia, finland, france, georgia, germany, greece, hungary, ireland, italy, kosovo, latvia, lithuania, luxembourg, moldavia, netherlands, new-zealand, north-macedonia, norway, poland, portugal, romania, serbia, slovakia, slovenia, spain, sweden, switzerland, turkiye, ukraine, unitedkingdom, uzbekistan] (optional)
