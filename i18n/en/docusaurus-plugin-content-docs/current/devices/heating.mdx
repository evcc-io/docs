...
loadpoints:
  - title: Meine Wärmepumpe
    ...
    enable:
      threshold: -1300 # This is an example. Use negativ values for power feedin to the grid.
      delay: 5m
    disable:
      threshold: 150 # This is an example. Use positive values for power consumption from the grid.
      delay: 20m  #Attention, some heatpumps require a minimum runtime to reach long lifetime or warranty conditions
meters:
  - name: heatpump_power
    type: template
