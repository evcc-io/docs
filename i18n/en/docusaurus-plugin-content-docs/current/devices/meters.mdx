...
<DeviceConfig code={`meters:
    ...
    - name: my_grid
      ...
      batteryconfiguri: /config # Firmware starting with 1.36.5-1 require /api/config., [/config, /api/config] (optional)`} />
...
<DeviceConfig code={`meters:
    - name: my_grid
      ...
      usage: grid
      url: # URL of the middleware's "data" context, The URL is for example: http://zaehler.network.local:8080/api/data (optional)
      importuuid:
      exportuuid:`}  />
