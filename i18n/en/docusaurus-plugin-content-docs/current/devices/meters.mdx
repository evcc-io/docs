...
<DeviceConfig code={`meters:
    ...
    - name: my_grid
      ...
      id: 200 # Meter adress of primary or secondary meters. On the web interface of the inverter, only the address of the first meter (e.g., 200) can be set. Additional meters receive an ascending number (e.g., 201). (optional)`} />
...
<DeviceConfig code={`meters:
    ...
    - name: my_grid
      ...
      cache: 10s # Time interval with when data should be reloaded from the vehicle (optional)`} />
