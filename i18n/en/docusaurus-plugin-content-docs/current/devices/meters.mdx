...
<DeviceConfig
  code={`meters:
    - name: my_grid
      ...
      tokenid: # QcellsCloud TokenID, Go to https://qhome-ess-g3.q-cells.eu/#/api/ or https://qhome-ess-g3.q-cells.us/#/api/ and take the value of "ObtaintokenID".
      serial: # Serial number, Go to https://qhome-ess-g3.q-cells.eu/blue/#/inverter or https://qhome-ess-g3.q-cells.us/blue/#/inverter and take the value of registration number.`}
/>
