...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      password: # Password, Password for admin API (optional)`} advanced={`chargers:
    - name: my_charger
      type: template
      template: evecube
      host: 192.168.1.100 # IP address or hostname, Hostname or IP address
...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      user: # Username, e.g. email address, user id, etc. (optional)
      password: # Password, Use single quotes in case of leading zeros (optional)`} advanced={`chargers:
    - name: my_charger
      type: template
      template: zaptec
      id: # ID, Charger ID (optional)
...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      enabled: false # Enabled, optional`} advanced={`chargers:
    - name: my_charger
      type: template
      template: demo-charger
      status: A # Charge status, [A, B, C]
...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      uri: http://192.168.0.10:8080/semp # SEMP base URL, HTTP(S) address`} advanced={`chargers:
    - name: my_charger
      type: template
      template: semp-charger
...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      lon: 9.1275 # Longitude, optional`} advanced={`chargers:
    - name: my_charger
      type: template
      template: vehicle-api
      geofence_enabled: false # Enable geofencing, optional
...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      firmware: <1.1.3 # Firmware version. Choose '>=1.1.3' for word-swap, [<1.1.3, >=1.1.3] (optional)`} advanced={`chargers:
    - name: my_charger
      type: template
      template: lambda-zewotherm
      host: 192.0.2.2 # IP address or hostname
