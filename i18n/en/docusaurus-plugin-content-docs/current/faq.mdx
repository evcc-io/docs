...
In the evcc UI, go to **Settings** → **System** → **Reset** to find options for resetting various data.

**Reset charging sessions:**
Deletes your charging session history.

**Reset configuration & settings:**
Deletes all devices, services, plans and other settings configured via the UI.
Additionally, cached data (e.g. tariff information) and meter readings are deleted.
...
Alternatively, you can delete individual cached data via the command line:
