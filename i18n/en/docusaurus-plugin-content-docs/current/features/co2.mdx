...
In this example, we'll use data from GrünstromIndex. See tariffs for a list of all supported data sources.
...
By using charging plans, you can control CO₂-optimised charging even more precisely.
...
:::Tip
If you have configured a dynamic electricity tariff, it will be preferred.
