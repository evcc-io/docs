...
<DeviceConfig code={`tariffs:
    grid:
      type: template
      template: awattar
      region: AT # [DE, AT] (optional)`} advanced={`tariffs:
    grid:
      type: template
      template: awattar
...
<DeviceConfig code={`tariffs:
    grid:
      type: template
      template: energinet
      region: dk1 # [dk1, dk2] (optional)`} advanced={`tariffs:
    grid:
      type: template
      template: energinet
      region: dk1 # [dk1, dk2] (optional)
      charges: # Additional fixed charge per kWh (e.g. 0.05 for 5 cents) (optional)
      tax: # Additional percentage charge (e.g. 0.2 for 20%) (optional)
      formula: math.Max((price + charges) * (1 + tax), 0.0) # Individual formula for calculating the price (optional)`} />
...
<DeviceConfig code={`tariffs:
    grid:
      ...
      currency: EUR # [DKK, EUR, NOK, PLN, RON, SEK] (optional)`} advanced={`tariffs:
    grid:
      type: template
      template: nordpool
      region: GER # [EE, LT, LV, AT, BE, FR, GER, NL, PL, DK1, DK2, FI, NO1, NO2, NO3, NO4, NO5, SE1, SE2, SE3, SE4, TEL, SYS] (optional)
      currency: EUR # [DKK, EUR, NOK, PLN, RON, SEK] (optional)
      charges: # Additional fixed charge per kWh (e.g. 0.05 for 5 cents) (optional)
      tax: # Additional percentage charge (e.g. 0.2 for 20%) (optional)
      formula: math.Max((price + charges) * (1 + tax), 0.0) # Individual formula for calculating the price (optional)`} />
