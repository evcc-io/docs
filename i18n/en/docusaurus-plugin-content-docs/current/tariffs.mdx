  ...
  advanced={`tariffs:
    solar:
      - type: template
        ...
        rossmodel: 0.0342 # Cooling type [Ross Model], Well Cooled (0.0200), Free Standing (0.0208), Flat on Roof (0.0260), Not So Well Cooled (0.0342), Transparent PV (0.0455), Facade Integrated (0.0538), On Sloped Roof (0.0563) [sciencedirect.com](https://www.sciencedirect.com/science/article/pii/S0038092X20309107) (optional)
        interval: 1h # Interval, optional`}
/>
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/tariff  -->
