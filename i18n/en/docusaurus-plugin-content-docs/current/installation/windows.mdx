...
- Go through the tabs of the dialog.
  ...
  - **Application**:
    ...
    ![Application](win11-nssm/win11-nssm_01_Application.png)
  ...
  - **Details**:
    ...
    ![Details](win11-nssm/win11-nssm_02_Details.png)
  ...
  - **Log on**:
    ...
    ![Log on](win11-nssm/win11-nssm_03_Log_on.png)
  ...
  - **Dependencies**:
    ...
    ![Dependencies](win11-nssm/win11-nssm_04_Dependencies.png)

    Adding `NlaSvc` as a dependency ensures the network is ready before evcc starts.

  - **Process**:

    ![Process](win11-nssm/win11-nssm_05_Process.png)

    Keep defaults.

  - **Shutdown**:

    ![Shutdown](win11-nssm/win11-nssm_06_Shutdown.png)
  ...
  - **Exit actions**:
    ...
    ![Exit actions](win11-nssm/win11-nssm_07_Exit_actions.png)
  ...
  - **I/O**:
    ...
    ![I/O](win11-nssm/win11-nssm_08_IO.png)
  ...
  - **File rotation**:
    ...
    ![File rotation](win11-nssm/win11-nssm_09_File_rotation.png)

    Optional: enable log rotation to limit log file sizes.

  - **Environment**:

    ![Environment](win11-nssm/win11-nssm_10_Environment.png)
