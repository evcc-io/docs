...
1. A **working** evcc configuration is required. There are two options:
   Either you follow the [instructions](./configuration#configuration-without-wizard) to create a manual configuration or you use the
   configuration wizard and follow these [instructions](./configuration#configuration-with-wizard).
