...
1. A **working** evcc configuration is required. There are two possibilities:
   Either you follow the [instructions](../installation/configuration) to create a manual configuration or you use the configuration wizard.
