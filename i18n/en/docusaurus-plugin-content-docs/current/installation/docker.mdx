...
If you haven't worked with Docker before, we recommend a direct installation as described in the [Linux](/installation/linux) or [macOS](/installation/macos) guide.
...
1. **Assistant on another system:** Run `evcc configure` beforehand on a [Linux](/installation/linux), [macOS](/installation/macos) or [Windows](/installation/manual) system.
