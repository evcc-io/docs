...
Now follow these instructions to fill the evcc configuration file with a template content [Configuration (manual)](./configuration#configuration-without-configuration-wizard)
