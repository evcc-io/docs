...
|-----------|-----------|------|----------|
| Gebotszone<br/>`bzn` | siehe https://api.energy-charts.info/#/prices/day_ahead_price_price_get | Standard: `DE-LU`<br/>Auswahl: `AT`, `BE`, `CH`, `CZ`, `DE-LU`<br/>, `DE-AT-LU`, `DK1`, `DK2`, `FR`, `HU`<br/>, `IT-NORTH`, `NL`, `NO2`, `PL`, `SE4`<br/>, `SI` | ja |
