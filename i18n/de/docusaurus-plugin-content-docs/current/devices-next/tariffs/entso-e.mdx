...
|-----------|-----------|------|----------|
| `securitytoken` | Registrierung und anschließende Helpdesk-Anfrage erforderlich. Details zum Ablauf gibts hier https://transparency.entsoe.eu/content/static_content/Static%20content/web%20api/Guide.html#_authentication_and_authorisation |  | nein |
| `domain` | siehe https://transparency.entsoe.eu/content/static_content/Static%20content/web%20api/Guide.html#_areas | Beispiel: `BZN\|DE-LU` | nein |
