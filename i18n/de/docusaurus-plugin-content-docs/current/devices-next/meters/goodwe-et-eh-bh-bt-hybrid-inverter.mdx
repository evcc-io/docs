...
<DeviceConfig code={`meters:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      type="meter"
      name="goodwe-et-eh-bh-bt-hybrid-inverter"
      size="400px"
      alt="GoodWe ET/EH/BH/BT Hybrid Inverter"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `goodwe-hybrid`

| Name | Erklärung | Wert | Optional |
|-----------|-----------|------|----------|
| Modbus Typ<br/>`modbus` |  | Auswahl: `rs485`, `tcpip`, `udp` | nein |
| Batteriespeichernummer<br/>`battery` |  | Standard: `1`<br/>Auswahl: `1`, `2` | nein |
