...
| Strom in Phase 1<br/>`l1currentuuid` | Die vzlogger Kanal uuid für Strom in Phase 1 (OBIS Code 31.7.0) |  | nein |
| Strom in Phase 2<br/>`l2currentuuid` | Die vzlogger Kanal uuid für Strom in Phase 2 (OBIS Code 51.7.0) |  | nein |
| Strom in Phase 3<br/>`l3currentuuid` | Die vzlogger Kanal uuid für Strom in Phase 3 (OBIS Code 71.7.0) |  | nein |
| Leistung in Phase 1<br/>`l1poweruuid` | Die vzlogger Kanal uuid für Leistung in Phase 1 (OBIS Code 36.7.0) |  | nein |
| Leistung in Phase 2<br/>`l2poweruuid` | Die vzlogger Kanal uuid für Leistung in Phase 2 (OBIS Code 56.7.0) |  | nein |
| Leistung in Phase 3<br/>`l3poweruuid` | Die vzlogger Kanal uuid für Leistung in Phase 3 (OBIS Code 76.7.0) |  | nein |
| Spannung in Phase 1<br/>`l1voltageuuid` | Die vzlogger Kanal uuid für Spannung in Phase 1 (OBIS Code 32.7.0) |  | nein |
| Spannung in Phase 2<br/>`l2voltageuuid` | Die vzlogger Kanal uuid für Spannung in Phase 2 (OBIS Code 52.7.0) |  | nein |
| Spannung in Phase 3<br/>`l3voltageuuid` | Die vzlogger Kanal uuid für Spannung in Phase 3 (OBIS Code 72.7.0) |  | nein |
