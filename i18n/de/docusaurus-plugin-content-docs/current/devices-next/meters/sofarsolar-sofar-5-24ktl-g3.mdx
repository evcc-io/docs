...
|-----------|-----------|------|----------|
| `modbus` |  | Auswahl: `tcpip`, `rs485` | nein |
| `storageunit` | Nummer des Batteriespeichers. Im Fall eines BTS Speichers nicht die Adresse eines BTS 5K Batteriemodules, sondern der Speicherturm (BTS 5K-BDU Steuerungseinheit mit 1-4 BTS 5K Modulen). | Standard: `1` | nein |
