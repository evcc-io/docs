...
## Templateparameter `tq-em420`

| Name | Erklärung | Wert | Optional |
|-----------|-----------|------|----------|
| IP-Adresse oder Hostname<br/>`host` |  | Beispiel: `192.0.2.2` | ja |
| Port<br/>`port` |  | Standard: `80` | nein |
| API Gerätepfad<br/>`device` | JSON-Schnittstelle -> Datenendpunkt | Standard: `local` | nein |
| Accesstoken<br/>`token` | Token des EM420 (Erstellen unter Profil -> Zugangsschlüssel) | Beispiel: `ey...` | ja |
