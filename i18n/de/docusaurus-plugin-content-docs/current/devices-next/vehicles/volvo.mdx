...
| `vccapikey` | VCC API Key deiner \[Volvo Developer App\](https://developer.volvocars.com/). |  | ja |
| `clientId` | Client ID deiner \[Volvo Developer App\](https://developer.volvocars.com/). |  | ja |
| `clientSecret` | Client Secret deiner \[Volvo Developer App\](https://developer.volvocars.com/). |  | ja |
| `redirectUri` | Redirect-URI deiner EVCC-Instanz, Format: http://evcc.local:7070/oauth/callback. Muss mit der Redirect-URI übereinstimmen, die in deiner Volvo Developer App festgelegt ist. |  | ja |
