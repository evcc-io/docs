...
## Templateparameter `volvo-connected`
...
| VCC API Key<br/>`vccapikey` | aus \[Volvo Developer App\](https://developer.volvocars.com/). |  | ja |
| Client ID<br/>`clientId` | aus \[Volvo Developer App\](https://developer.volvocars.com/). |  | ja |
| Client Secret<br/>`clientSecret` | aus \[Volvo Developer App\](https://developer.volvocars.com/). |  | ja |
| Redirect URI<br/>`redirectUri` | Redirect-URI deiner evcc-Instanz, Format: http://evcc.local:7070/oauth/callback. Muss mit der Redirect-URI übereinstimmen, die in deiner Volvo Developer App festgelegt ist. |  | ja |
| Fahrzeugidentifikationsnummer<br/>`vin` | Wenn mehrere Fahrzeuge eines Herstellers vorhanden sind | Beispiel: `WF0FXX...` | nein |
