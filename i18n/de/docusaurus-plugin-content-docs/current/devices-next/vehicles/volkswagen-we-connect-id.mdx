...
<DeviceConfig code={`vehicles:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="Volkswagen We Connect ID"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `vw`
...
| Fahrzeugidentifikationsnummer<br/>`vin` | Wenn mehrere Fahrzeuge eines Herstellers vorhanden sind | Beispiel: `WVWZZZ...` | nein |
