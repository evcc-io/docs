...
| Region<br/>`region` |  | Standard: `EMEA`<br/>Auswahl: `EMEA`, `APAC`, `NORAM` | ja |
| Access token<br/>`accessToken` |  |  | ja |
| Refresh token<br/>`refreshToken` |  |  | ja |
| Fahrzeugidentifikationsnummer<br/>`vin` | Wenn mehrere Fahrzeuge eines Herstellers vorhanden sind | Beispiel: `V...` | nein |
