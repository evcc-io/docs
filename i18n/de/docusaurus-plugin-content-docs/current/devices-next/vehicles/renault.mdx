...
| Fahrzeugidentifikationsnummer<br/>`vin` | Wenn mehrere Fahrzeuge eines Herstellers vorhanden sind | Beispiel: `WREN...` | nein |
...
| Aufweckmechanismus<br/>`wakeupmode` |  | Standard: `default`<br/>Auswahl: `default`, `alternative`, `MY24` | nein |
