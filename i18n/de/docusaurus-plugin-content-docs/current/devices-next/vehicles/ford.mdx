...
## Templateparameter `ford-connect`
...
| FordConnect API Client ID<br/>`clientid` | Einrichtung unter https://developer.ford.com |  | ja |
| FordConnect API Client Secret<br/>`clientsecret` | Einrichtung unter https://developer.ford.com |  | ja |
| Access token<br/>`accessToken` |  |  | ja |
| Refresh token<br/>`refreshToken` |  |  | ja |
