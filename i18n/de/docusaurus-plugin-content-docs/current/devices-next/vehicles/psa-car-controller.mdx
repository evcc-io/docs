...
## Templateparameter `flobz`

| Name | Erklärung | Wert | Optional |
|-----------|-----------|------|----------|
| URL<br/>`url` |  | Beispiel: `http://192.0.2.2` | ja |
...
| Alternativer Wakeup-Code<br/>`wakeup_alt` | Kann zu erhöhter Entladung der 12V-Batterie führen. |  | nein |
