...
| Tronity API Client ID<br/>`clientid` | Einrichtung unter https://app.tronity.tech |  | ja |
| Tronity API Client Secret<br/>`clientsecret` | Einrichtung unter https://app.tronity.tech |  | ja |
