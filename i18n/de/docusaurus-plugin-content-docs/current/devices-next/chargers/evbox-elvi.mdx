---
title: EVBox Elvi
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ocpp-evbox-elvi.yaml
...
## Templateparameter `ocpp-evbox-elvi`
...
| Zählernummer<br/>`meter` |  | Standard: `true` | nein |
