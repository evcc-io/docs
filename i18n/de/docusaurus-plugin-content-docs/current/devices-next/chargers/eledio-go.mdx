---
title: eledio go
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ocpp-enercab.yaml
...
<div className="device-detail-container">
  <div className="device-detail-content">
    <DeviceFeatures features="1p3p,sponsorship" />
...
## Templateparameter `ocpp-enercab`
