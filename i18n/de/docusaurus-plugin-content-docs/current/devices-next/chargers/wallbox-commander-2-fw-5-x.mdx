---
title: wallbox Commander 2 (FW 5.x)
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/wallbox-fw5.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="wallbox Commander 2 (FW 5.x)"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `wallbox-fw5`
...
| Zählerwerte für die Übertragung<br/>`metervalues` | Manuelle Vorgabe der zu konfigurierenden Zählerwerte (MeterValuesSampledData) | Standard: `-Current.Offered,Power.Offered`<br/>Beispiel: `Energy.Active.Import.Register,Power.Active.Import,SoC,Current.Offered,Power.Offered,Current.Import,Voltage` | nein |
