...
| Manuelle Vorgabe der zu konfigurierenden Zählerwerte (MeterValuesSampledData)<br/>`metervalues` |  | Standard: `-Current.Offered,Power.Offered`<br/>Beispiel: `Energy.Active.Import.Register,Power.Active.Import,SoC,Current.Offered,Power.Offered,Current.Import,Voltage` | nein |
