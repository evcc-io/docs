---
title: Charge Amps Halo
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ocpp-chargeamps.yaml
...
## Templateparameter `ocpp-chargeamps`
