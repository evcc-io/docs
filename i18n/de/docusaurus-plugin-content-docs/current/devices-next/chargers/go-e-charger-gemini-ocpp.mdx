---
title: go-e Charger Gemini (OCPP)
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ocpp-goe.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="go-e Charger Gemini (OCPP)"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `ocpp-goe`
