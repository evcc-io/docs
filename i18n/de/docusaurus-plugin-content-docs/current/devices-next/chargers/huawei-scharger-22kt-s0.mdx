---
title: Huawei SCharger-22KT-S0
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ocpp-huawei.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="Huawei SCharger-22KT-S0"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `ocpp-huawei`
