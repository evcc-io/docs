---
title: Homecharge Homecharger
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ocpp-homecharge.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="Homecharge Homecharger"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `ocpp-homecharge`
