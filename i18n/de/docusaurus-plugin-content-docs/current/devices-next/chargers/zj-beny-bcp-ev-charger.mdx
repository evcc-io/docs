---
title: ZJ Beny BCP EV charger
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ocpp-beny.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="ZJ Beny BCP EV charger"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `ocpp-beny`
