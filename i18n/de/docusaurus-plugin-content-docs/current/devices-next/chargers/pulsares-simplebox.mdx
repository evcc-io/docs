---
title: Pulsares SimpleBox
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/pulsares.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="Pulsares SimpleBox"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `pulsares`
