---
title: Schrack i-CHARGE CION
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/ichargecion.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="Schrack i-CHARGE CION"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Templateparameter `ichargecion`
