...
Für FENECON FEMS Systeme ist für die aktive Batteriesteuerung eine kommerzielle Lizenz _FEMS App Modbus/TCP Schreibzugriff_ erforderlich.<br/><br/>
...
Für FENECON FEMS Systeme ist für die aktive Batteriesteuerung eine kommerzielle Lizenz _FEMS App REST/JSON Schreibzugriff_ erforderlich.<br/><br/>
...
<DeviceConfig
  code={`meters:
    - name: my_grid
      ...
      tokenid: # QcellsCloud TokenID, Token ID von https://qhome-ess-g3.q-cells.eu/#/api/ oder https://qhome-ess-g3.q-cells.us/#/api/ hier eintragen.
      serial: # Seriennummer, Registriernummer von https://qhome-ess-g3.q-cells.eu/blue/#/inverter oder https://qhome-ess-g3.q-cells.us/blue/#/inverter hier eintragen.`}
/>
