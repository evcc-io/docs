...
<DeviceConfig code={`meters:
    ...
    - name: my_battery
      ...
      timeout: 15s # optional
      storageunit: 1 # optional
      maxchargepower: 10000 # Maximale Ladeleistung für erzwungenes Laden des Speichers in Watt. (optional)
      capacity: 50 # Akkukapazität in kWh (optional)
...
<DeviceConfig code={`meters:
    ...
    - name: my_battery
      ...
      capacity: 50 # Akkukapazität in kWh (optional)
      maxchargepower: 3300 # Maximale Ladeleistung für erzwungenes Laden des Speichers in Watt. (optional)
...
<DeviceConfig code={`meters:
    ...
    - name: my_battery
      ...
      timeout: 10s # optional
      capacity: 50 # Akkukapazität in kWh (optional)
      maxchargepower: # Maximale Ladeleistung für erzwungenes Laden des Speichers in Watt. (0 um automatisch den Wert der maximalen BDC-Nennleistung einzustellen) (optional)`} />
