...
Achtung: Die aktive Batteriesteuerung bzw. die Verhindere Entladung im Schnell-Modus funktioniert bei SMA nicht bei jeder Firmware. Beim Sunny Home Manager 2.0 gibt es einen Bug in der Version 2.14.13.R und bei den Sunny Boy Storage sollte die Firmware >= 03.12.74.R sein.
