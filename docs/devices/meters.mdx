...
meters:
  - name: my_meter
    ...
    soc: # optional battery soc (%)
      source: # plugin type
      # ...
    currents: # optional phase currents (A), e.g. detection of active charge phases
      ...
      - source: # L3 plugin type
        # ...
    powers: # optional phase power (W), e.g. sign recognition, if currents have no sign 
      - source: # L1 plugin type
        # ...
      - source: # L2 plugin type
        # ...
      - source: # L3 plugin type
        # ...
    voltages: # optional phase voltage (V), e.g. detection of charger phases connection (1p or 3p)
      - source: # L1 plugin type
        # ...
      - source: # L2 plugin type
        # ...
