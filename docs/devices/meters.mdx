...
Zur Nutzung der Funktion Batterie Discharge Control muss über den Solarmax Support die Funktion "Connectivity+" freigeschaltet werden.
Verfügbar ab Software 3.4.4..
