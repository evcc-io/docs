...
- **Integrierter Zähler**: Integration vorhanden. Verfügbarkeit je nach Modell.
...
<DeviceFeatures features="mA,meter" />
...
[library.e.abb.com](https://library.e.abb.com/public/8f07987a3a284da6bf4e4f8f53cd6502/ABB_Terra_AC_Charger_OCPP1.6_ImplementationOverview%20_v1.8_FW1.6.6.pdf)
...
<DeviceFeatures features="mA,1p3p,meter" />
...
<DeviceFeatures features="iso151182,mA,rfid,meter" />
...
<DeviceFeatures features="mA,rfid,meter" />
...
<DeviceFeatures features="mA,rfid,1p3p,meter" />
...
<DeviceFeatures features="rfid,meter" />
...
<DeviceFeatures features="rfid,1p3p,meter" />
...
<DeviceFeatures features="mA,meter,sponsorfree" />
...
<DeviceFeatures features="iso151182,mA,rfid,1p3p,meter,sponsorfree" />
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      template: elli-2
      ski: # Identifikationsschlüssel (SKI), Üblicherweise im Web Interface der Wallbox zu finden
      ip: 192.0.2.2 # IP-Adresse, IP-Adresse der Wallbox. Erforderlich für Phasenumschaltung und RFID-Identifikation. (optional)
      password: # Passwort, Techniker-Passwort. Erforderlich für Phasenumschaltung und RFID-Identifikation. (optional)`}
/>
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/charger  -->
...
<DeviceFeatures features="mA,rfid,1p3p,meter,sponsorfree" />

Firmware-Anforderungen= Smart/Touch Pro ab "M3W_3.11STP", Business ab "M3W_4.03PTB". Während der Phasen-Umschaltung pausiert die Ladung für zwei Minuten. Informationen zur Ladefreigabe (AutoStart, App, RFID, Button), bitte der Wallbox Dokumentation von DaheimLaden entnehmen.
...
AC MAX Smart erfordert Firmware >= v01.26.38.02 für Modbus TCP via WiFi.
...
<DeviceFeatures features="rfid,1p3p,meter,sponsorfree" />
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      password: # E3DC Portal Passwort, Zugangspasswort des Dienstes
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      password: # Passwort, wie Login für Easee App oder Web Portal ([easee.cloud](https://easee.cloud))
...
<DeviceFeatures features="1p3p,meter,sponsorfree" />
...
[enercab.at](https://www.enercab.at/index.php?controller=attachment&id_attachment=311)
...
<DeviceFeatures features="meter,sponsorfree" />
...
<DeviceFeatures features="mA,1p3p,meter,sponsorfree" />
...
<DeviceConfig
  ...
  advanced={`chargers:
    - name: my_charger
      ...
      user: admin # Benutzerkonto, Benutzername für Admin-API (optional)
      password: # Passwort, Passwort für Admin-API (optional)
      connector: 1 # Anschlussnummer, Anschluss-Nummer (1-4) (optional)`}
/>
<SponsorshipRequired />
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/charger  -->
...
Die Ladestation und evcc müssen sich im selben Netzwerksegment (VLAN) befinden, da die Erkennung über UDP-Broadcast erfolgt. Broadcasts werden von den meisten Routern nicht zwischen VLANs weitergeleitet.
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      serial: '0906252400004617' # Seriennummer (16-stellige Hex-Zeichenkette), Die Seriennummer steht auf dem Typenschild der Ladestation (8 Byte als Hex).
      password: # Passwort (wie in der EVSE Master App gesetzt), Das Passwort wird in der EVSE Master App unter Geräteeinstellungen konfiguriert. App und evcc dürfen nicht gleichzeitig verbunden sein.`}
/>
<SponsorshipRequired />
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/charger  -->
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      serial: # Seriennummer, Seriennummer der Wallbox (wird automatisch erkannt, wenn nur eine Wallbox im Account vorhanden ist) (optional)`}
/>
<SponsorshipRequired />
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/charger  -->
...
<DeviceFeatures features="mA,rfid,1p3p,sponsorfree" />
...
<DeviceFeatures features="iso151182,mA,1p3p,meter,sponsorfree" />
...
<DeviceConfig
  ...
  advanced={`chargers:
    - name: my_charger
      ...
      identify: # RFID-Reader verwenden, Unbedingt [\`openWB Issue 2832\`](https://github.com/openWB/core/issues/2832) beachten, sollte nicht für Zugangsschutz verwendet werden! (optional)`}
/>
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/charger  -->
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      connector: 1 # Anschluss-ID, Bei Ladestationen mit mehreren Anschlüssen. Zählung beginnt bei 1.`}
/>
<SponsorshipRequired />
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/charger  -->
...
<DeviceFeatures features="iso151182,mA,meter,sponsorfree" />
...
<DeviceConfig
  ...
  advanced={`chargers:
    - name: my_charger
      ...
      chargeMode: normal # Lademodus, [normal, smart] (optional)`}
/>
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/charger  -->
...
Die TWC Wallbox ist nicht direkt regelbar. Die Regelung erfolgt über das Fahrzeug. Das Fahrzeug muss am TWC3 Ladepunkt ausgewählt sein. Aktuell ausschließlich mit [docs.evcc.io](https://docs.evcc.io/docs/devices/vehicles#tesla) unterstützten Tesla Fahrzeugen nutzbar.
...
Falls notwendig wird die WARP-eigene automatische Phasenumschaltung von EVCC beim Verbinden mit der Wallbox deaktiviert. Siehe [docs.warp-charger.com](https://docs.warp-charger.com/docs/mqtt_http/api_reference/evse#evse_phase_auto_switch_warp3).
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      energyManagerPassword: # Energy Manager Passwort, optional`}
  advanced={`chargers:
    - name: my_charger
      type: template
      template: tinkerforge-warp2-em-ws
...
OCPP 1.6J (Box-Level Integration) [docs.zaptec.com](https://docs.zaptec.com/docs/ocpp16j)
...
<DeviceConfig
  code={`chargers:
    - name: my_charger
      ...
      status: sensor.charger_status # Ladestatus-Sensor, Entitäts-ID für Ladestatus (A=bereit, B=verbunden, C=laden)
