...
Für die Phasenumschaltung ist eine aktualisierte Firmware notwendig. Dazu bitte DaheimLaden Support kontaktieren.
...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      longitude: # Ladestandort Längengrad, Längengrad Ihres Ladestandorts in Dezimalgrad (z.B. 13.404954) (optional)`} advanced={`chargers:
    - name: my_charger
      type: template
      template: vehicle-api
      geofence_enabled: false # Geofencing aktivieren, optional
