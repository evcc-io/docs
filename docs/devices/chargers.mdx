...
<DeviceConfig code={`chargers:
    - name: my_charger
      ...
      charger: EH______
      timeout: 20s # Spezifisches Timeout für Easee API Interaktionen. Kann Warnungen und Fehler bei träger Easee API reduzieren. (optional)
