...
chargers:
  - name: my_charger
    type: template
    template: easee
    user: # E-Mail Adresse oder Telefonnummer mit Ländervorwahl (+XX)
...
Das Teslafahrzeug muss dem TWC3 im evcc UI zugewiesen sein.
...
* Backend-URL (Central System) in der Wallboxkonfiguration: `ws://<evcc-IP-Adresse>:8887/`
