...
Für die Nutzung mit evcc muss die Wallbox mit einer aktuellen Firmware mit Modbus-Unterstützung betrieben werden. Bitte mit dem Hersteller abklären.
...
Die Wallbox ist durch evcc nicht direkt regelbar. Die Regelung erfolgt über das Fahrzeug. Deshalb ist die Wallbox ausschließlich mit Tesla Fahrzeugen nutzbar. 
The Wallbox cannot be controlled directly by evcc. Control is via the vehicle. Therefore, the wall box can only be used with Tesla vehicles.
