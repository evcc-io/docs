...
Die TWC Wallbox ist nicht direkt regelbar. Die Regelung erfolgt über das Fahrzeug. Das Fahrzeug muss dem TWC3 Ladepunkt zugewiesen sein. Aktuell ausschließlich mit [Tesla Fahrzeugen](https://docs.evcc.io/docs/devices/vehicles#tesla) nutzbar.
