...
1. evcc starten mit eebus configuration (Certs, ski etc)
2. Auf die EV Install App mit der wallbox verbinden und Energie Manager auswahlen. Sollte die EVCC auftauchen durch das discovery Protokoll. 
3. Auf Verbinden drücken und sich den ski in die logs raus suchen.
4. SKI in die evcc chargers anpassen
5. Evcc neu starten.
Achtung: Probleme mit homeassistant und ipv6 [hier](https://github.com/evcc-io/hassio-addon/issues/99)
