...
Hinweis zur Konfiguration des Wattpilot mittels solar.wattpilot app: das Symbol neben dem Beispiel-OCPP-Server "wss://<username>:<password>@ocpp.cloud.fronius.com/<UID>" dient zur Konfiguration. Hier entsprechend dann "ws://<IP-vom-evcc-host>:8887/ eingeben und unten "Füge SN zur URL" aktivieren.
