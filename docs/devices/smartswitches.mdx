...
:::important Wichtig
Standardmäßig geht evcc von 3-phasigem Betrieb aus.
Bei der Verwendung von Smart Switches musst du die Phasenanzahl über die UI am Ladepunkt manuell auf **1-phasig** setzen.
:::
...
Zudem wird der `soc` des Chargers (sofern verfügbar) als Temperatur in °C angezeigt.
