...
loadpoints:
  - title: Meine Wärmepumpe
    ...
    enable:
      threshold: -1300 # Dies ist ein Beispiel bei dem die Wärmepumpe bei 1300W Überschuss aktiviert wird
      delay: 5m
    disable:
      threshold: 150 # Dies ist ein Beispiel bei dem die Wärmepumpe bei mehr als 150W Netzbezug deaktiviert wird
      delay: 20m  #Achtung, manche Wärmepumpen benötigen eine gewisse Mindestlaufzeit pro Start um eine lange Lebensdauer zu erreichen/ laut Garantiebedingungen
