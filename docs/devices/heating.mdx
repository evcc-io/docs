...
Letztendlich entscheidet das Gerät aber abhängig vom aktuellen Betriebszustand und seiner Konfiguration immer selbst ob und wieweit es diesem Wunsch auch tatsächlich entsprechen wird.

Das folgende Diagramm zeigt den Aufbau:

![Diagram für die Steuerung einer Wärmepumpe über ein SG-Ready Relais](./heating/sgready.svg)
