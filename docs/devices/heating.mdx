...
Bei aktivem [§ 14a EnWG Reduzierungssignal](/docs/features/14a-enwg-steuve) wird die Wärmepumpe automatisch in den **reduzierten Betrieb** versetzt.
Dies erfolgt über die SG-Ready Schnittstelle und trägt zur Netzstabilität bei.
