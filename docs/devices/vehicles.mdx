...
Die Steuerung von Fahrzeugen im Zusammenspiel mit einem Tesla Wall Connector erfolgt über einen evcc Proxy-Server und benötigt einen Sponsor Token. Der virtuelle evcc Schlüssel muss auf dem Fahrzeug installiert sein.
