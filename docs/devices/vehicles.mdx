...
<DeviceConfig
  code={`vehicles:
    - name: my_car
      ...
      clientid: # FordConnect Query Client ID, Einrichtung unter https://developer.ford.com/developer-eu
      clientsecret: # FordConnect Query Client Secret, Einrichtung unter https://developer.ford.com/developer-eu
      redirecturi: # FordConnect Query Redirect URL, Einrichtung unter https://developer.ford.com/developer-eu
      title: # Titel, Wird in der Benutzeroberfläche angezeigt (optional)
      capacity: 50 # Akkukapazität (kWh), optional
