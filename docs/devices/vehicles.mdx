...
<DeviceConfig
  code={`vehicles:
    - name: my_car
      ...
      topic: # Topic, Topic (ohne / am Anfang) (optional)
      timeout: 1h # Zeitüberschreitung, Akzeptiere keine Daten die älter sind als dieser Wert (optional)
      title: # Titel, Wird in der Benutzeroberfläche angezeigt (optional)
      capacity: 50 # Akkukapazität (kWh), optional`}
  advanced={`vehicles:
    - name: my_car
...
<DeviceConfig
  code={`vehicles:
    - name: my_car
      ...
      port: 1883 # Port, MQTT Broker Port (optional)
      topic: # Topic, Topic (ohne / am Anfang) (optional)
      timeout: 720h # Zeitüberschreitung, Akzeptiere keine Daten die älter sind als dieser Wert (optional)
      title: # Titel, Wird in der Benutzeroberfläche angezeigt (optional)
      capacity: 50 # Akkukapazität (kWh), optional
