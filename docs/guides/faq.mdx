...
- **1-phasiger Anschluss der Wallbox**: 1,4kW bis 3,6kW oder 7,2kW
- **3-phasiger Anschluss der Wallbox**: 4,2kW bis 11kW oder 22kW
...
### Ich habe kein Messgerät am Netzanschlusspunkt

evcc kann auch nur mit den PV Erzeugungsdaten arbeiten. Wir empfehlen dann den Wert [`residualPower`](/docs/reference/configuration/site#residualpower) in der Konfiguration unter [`site`](/docs/reference/configuration/site) mit dem typischen Hausverbrauch zu konfigurieren. So kann auch der tatsächlich PV Überschuss grob abgeschätzt werden.

_Tip:_ Wenn eine Hausbatterie installiert ist, sind diese Geräte meist schon vorhanden, man hat es vielleicht nur nicht gewusst ;)
