...
PV Überschuss wird anhand der Einspeisung am Netzanschluss ermittelt. Der Modus **Nur PV** wird bei Anlagen ohne Netzeinspeisung (Nulleinspeisung) derzeit nicht unterstützt.
