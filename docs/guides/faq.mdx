...
:::note Anmerkung
Dies gilt nur für die Kombination von Fahrzeugen und Wallbox, wo diese beiden über den Standard IEC61851 kommunizieren. Dies ist heute in den meissten Fällen die Regel.
