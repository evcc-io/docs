...
Das passiert, wenn ein Minimum-SoC definiert ist. Wird der Fahrzeug-SoC nicht erkannt, hat er den Wert 0. 

Ist der Fahrzeug-SoC kleiner als der definierte Minimum-SoC, wird bis zum Erreichen des Minimum-SoC mit voller Leistung geladen.
...
In den Wintermonaten ist die PV Erzeugung meisst unterhalb oder im Bereich der [Mindestleistung](#ich-habe-pv-überschuß-aber-das-auto-lädt-nicht). Um dennoch möglichst viel eigenen Strom ins Fahrzeug zu laden, kann man folgenden Trick anwenden:
