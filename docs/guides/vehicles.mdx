...
2. Einloggen und _Create a New project_ klicken
3. Klicke _Add Product_
4. _Electric Vehicle Status_ auswählen
5. _Purchase model_ &rarr; _Get For Free_ &rarr; _Package BYOCAR_ &rarr; _Confirm_ &rarr; _Subscribe_
6. Go to Project Page &rarr; _Generate Credentials_
