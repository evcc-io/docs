...
Hierbei ruft evcc den Ladestatus aller eingebundenen Fahrzeuge über die Hersteller-Schnittstelle ab. Sofern der Hersteller dies anbietet, erhält evcc automatisch den (hoffentlich) aktuellen Ladestatus der Fahrzeuge, also ob ein Fahrzeug an eine Ladesäule angeschlossen ist und ob es derzeit lädt.
