...
Die Verbindung zum Gerät ist prinzipiell vorhanden, jedoch wird der Verbindungsaufbau von der Gegenstelle abgewiesen. 

Die Gründe dafür können vielfältig sein. Typisch sind:
-	Der am Gerät freigegeben Port stimmt nicht mit dem in der Konfiguration angegebenen Port überein.
-	Der Modbus Server am Gerät ist nicht aktiviert (passiert regelmäßig z.B. bei Solaredge)
-	Es besteht schon eine Modbus Verbindung mit einem anderen System


### Fehler: i/o timeout

Auch hier ist eine Verbindung zum Gerät prinzipiell vorhanden, jedoch antwortet die Gegenstelle nicht innerhalb der vorgesehenen Zeit. Entweder kommt die Anfrage gar nicht beim Gerät an, oder die Antwort dauert zu lange. 

Typische Gründe sind:
-	Langsame oder schlechte Netzwerkverbindung. 
-	Das Gerät ist überlastet oder ausgefallen
