...
Steckst du dein Auto an einem sonnigen Tag an eine dumme Wallbox, wird ein Teil der geladenen Energie auch Sonnenstrom sein.
evcc hilft dir aber den Anteil der geladenen Sonnenenergie zu maximieren.

**Berechnung des Sonnenenergieanteils**

Wenn du gleichzeitig Energie aus mehreren Quellen beziehst (z.B. 50% PV, 50% Netzbezug), wird die eigene Energie zuerst dem Hausverbrauch zugeordnet.
