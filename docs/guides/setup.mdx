...
- Die Konfigurationsdatei `evcc.yaml`,
  ...
  <summary>
    d.h. deren Inhalt (*bitte Benutzernamen, Passwörter und ähnliches
    entfernen*).
  </summary>
...
Auf der [evcc Webseite](https://evcc.io/#live) und im "Auswertung Ladeenergie" Dialog der evcc UI zeigen wir aggreggierte Live-Ladedaten unserer Nutzer an. Wir sammeln diese Daten auf unserer zentralen api.evcc.io Instanz. Die Teilnahme daran ist natürlich freiwillig.

**Wie kann ich teilnehmen?**

Im "Auswertung Ladeenergie" Dialog kannst du unter "Live-Community" deine Daten teilen. Bislang konnte die Funktion auch über [`telemetry: true`](/docs/reference/configuration/telemetry/) aktiviert werden. Dieser Weg ist nun allerdings deprecated.
...
Unser Ziel ist es durch diese Daten mehr neue Nutzer für evcc zu begeistern und selbst mehr über das Nutzungsverhalten von evcc zu erfahren.

Die aggregierten Gesamtdaten können auch frei über https://api.evcc.io/v1/total abgerufen werden. Wenn ihr also Ideen für eigene kreative Visualisierungen habt, baut gerne was und erzählt uns davon.

Mehr Informationen findest du auch auf unserer [Datenschutzseite](https://cloud.evcc.io/privacy).
