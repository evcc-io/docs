...
Wenn du gleichzeitig Energie aus mehreren Quellen beziehst (z.B. 50% PV, 50% Netzbezug), wird die eigene Energie zuerst dem Haus, also allen nicht von evcc gesteuerten Verbrauchern, zugeordnet.
