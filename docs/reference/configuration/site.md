...
:::note
Im Modus `PV` startet die Ladung immer dann, wenn der Soc der Hausbatterie größer als der eingestellte `bufferSoc` ist und die Hausbatterie nicht geladen wird.
:::
