...
Dauer der Zwischenspeicherung von den Werten der online Fahrzeug API (Default: 15m). Kleinere Werte erhöhen die Anzahl der API Zugriffe, liefern dafür aber aktuellere Werte.
