...
Details findest du unter [Einrichtung → Sichern & Wiederherstellen](./configuration#sichern--wiederherstellen).
...
Eine vollständige Liste aller Optionen findest du in der [CLI-Dokumentation](/docs/reference/cli/evcc).
:::
