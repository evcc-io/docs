...
Die Einrichtung von evcc über Docker auf der Synology NAS ist über die GUI der Synology NAS ohne weitere Linux-Kenntnisse möglich. Hierbei sind zwei Modi möglich: Host oder Bridge. Welcher Mode der richtige ist, hängt vom Typ der Wallbox bzw. des Energiemessers ab. Für die Elli Charger Pro (oder Connect mit nachgerüstetem Energiemesser) ist bspw. der Host-Mode zu wählen. Hier die Anleitung dazu:
