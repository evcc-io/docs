...
Die Einrichtung von evcc über Docker auf der Synology NAS ist über zwei Varianten möglich, die abhängig davon sind, ob die Wallbox den EEBus verwendet. Dies ist z.B. bei der Elli Charger Pro (oder Connect mit nachgerüstetem Energiemesser) der Fall. Der Docker Container muss dann im Host-Mode eingerichtet werden. Dies ist hier beschrieben:
...
In anderen Fällen wird der Bridge-Mode empfohlen. Hier ist eine Anleitung dazu: [EVCC_Synology_Docker-2.pdf](https://github.com/evcc-io/docs/files/10365845/EVCC_Synology_Docker-2.pdf) (erstellt von at4hawo1)
