...
Solltest du noch nicht mit Docker gearbeitet haben, empfehlen wir eine direkte Installation wie in der [Linux](/installation/linux) oder [macOS](/installation/macos) Anleitung beschrieben
...
1. **Assistent auf anderem System:** Führe `evcc configure` vorher auf einem [Linux](/installation/linux), [macOS](/installation/macos) oder [Windows](/installation/manual) System aus.
