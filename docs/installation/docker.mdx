...
1. Es wird eine **funktionierende** evcc Konfiguration benötigt. Es gibt dabei zwei Möglichkeiten:
   Entweder du folgst der [Anleitung](./configuration#konfiguration-ohne-konfigurationsassistenten) zur Erstellung einer manuellen Konfiguration oder du benutzt den
   Konfigurationsassistenten und folgst dieser [Anleitung](./configuration#konfiguration-mit-konfigurationsassistenten).
