...
:::tip Empfohlen
Die Weboberfläche ist der einfachste und schnellste Weg, evcc einzurichten. Keine Konfigurationsdateien notwendig!
:::
...
Diese Methode nutzt eine `evcc.yaml` Datei und erfordert Kenntnisse im Umgang mit der Kommandozeile und YAML-Dateien. Für spezielle Anwendungsfälle und maximale Kontrolle.
:::
