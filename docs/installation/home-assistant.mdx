...
Bitte beachte, dass wir seit dem 16.02.2025 mit der Version 0.200.1 die Pfade im Addon geändert haben, um mit der [Vorgabe](https://developers.home-assistant.io/blog/2023/11/06/public-addon-config/) von Home Assistant konsitent zu sein.
