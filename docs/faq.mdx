...
In der evcc UI findest du unter **Einstellungen** → **Experimentell aktivieren** → **Sichern & Wiederherstellen** → **Zurücksetzen** Optionen zum Zurücksetzen verschiedener Daten.
