...
1. Konfiguriere ein neues Gerät direkt über die Weboberfläche unter **Einstellungen**.
...
In der evcc Weboberfläche findest du unter **Einstellungen** → **Sichern & Wiederherstellen** folgende Optionen:
