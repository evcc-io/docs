...
In der evcc UI findest du unter **Einstellungen** → **Experimentell** → **Sichern & Wiederherstellen** → **Zurücksetzen** Optionen zum Zurücksetzen verschiedener Daten.

**Ladevorgänge:**
Löscht den Verlauf deiner Ladevorgänge.

**Konfiguration & Einstellungen:**
Löscht alle konfigurierten Geräte, Dienste, Pläne, Caches, usw.
