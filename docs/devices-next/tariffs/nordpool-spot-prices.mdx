...
|-----------|-------------|-------|----------|
| `region` |  | Beispiel: `GER`<br/>Auswahl: `EE`, `LT`, `LV`, `AT`, `BE`<br/>, `FR`, `GER`, `NL`, `PL`, `DK1`<br/>, `DK2`, `FI`, `NO1`, `NO2`, `NO3`<br/>, `NO4`, `NO5`, `SE1`, `SE2`, `SE3`<br/>, `SE4`, `TEL`, `SYS` | no |
| `currency` |  | Standard: `EUR`<br/>Auswahl: `DKK`, `EUR`, `NOK`, `PLN`, `RON`, `SEK` | yes |
