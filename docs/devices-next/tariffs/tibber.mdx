...
|-----------|-------------|-------|----------|
| API Token<br/>`token` |  | Beispiel: `476c477d8a039529478ebd690d35ddd80e3308ffc49b59c65b142321aee963a4` | yes |
| Home ID<br/>`homeid` | Only required if you have multiple homes in your Tibber account. | Beispiel: `cc83e83e-8cbf-4595-9bf7-c3cf192f7d9c` | no |
