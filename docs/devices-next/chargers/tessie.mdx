...
| Define a location where the Tessie charger will work (always = always, no geofence) or a custom location (exact name) as defined in Tessie (Case sensitive)<br/>`location` |  | Beispiel: `tessiehome` | yes |
