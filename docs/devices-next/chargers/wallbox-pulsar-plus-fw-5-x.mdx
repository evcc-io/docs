...
| Manual specification of the meter values to be configured (MeterValuesSampledData)<br/>`metervalues` |  | Standard: `-Current.Offered,Power.Offered`<br/>Beispiel: `Energy.Active.Import.Register,Power.Active.Import,SoC,Current.Offered,Power.Offered,Current.Import,Voltage` | no |
