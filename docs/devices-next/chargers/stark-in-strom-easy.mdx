---
title: Stark in Strom Easy
custom_edit_url: https://github.com/evcc-io/evcc/blob/master/templates/definition/charger/evse-din.yaml
...
<DeviceConfig code={`chargers:
  ...
  <div className="device-detail-icon">
    <evcc-icon
      ...
      size="400px"
      alt="Stark in Strom Easy"
      className="device-detail-icon-img"
    ></evcc-icon>
  </div>
</div>

## Template Parameter `evse-din`
