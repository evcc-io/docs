...
| Vehicle Identification Number<br/>`vin` | If you own multiple vehicles from the same manufacturer | Beispiel: `WREN...` | no |
...
| Wakeup mechanism<br/>`wakeupmode` |  | Standard: `default`<br/>Auswahl: `default`, `alternative`, `MY24` | no |
