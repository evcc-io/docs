...
| FordConnect API Client ID<br/>`clientid` | Setup at https://developer.ford.com |  | yes |
| FordConnect API Client Secret<br/>`clientsecret` | Setup at https://developer.ford.com |  | yes |
| `accessToken` |  |  | yes |
| `refreshToken` |  |  | yes |
