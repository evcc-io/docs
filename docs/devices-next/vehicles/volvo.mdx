...
| `vccapikey` | VCC API Key of your \[Volvo Developer App\](https://developer.volvocars.com/). |  | yes |
| `clientId` | Client ID of your \[Volvo Developer App\](https://developer.volvocars.com/). |  | yes |
| `clientSecret` | Client Secret of your \[Volvo Developer App\](https://developer.volvocars.com/). |  | yes |
