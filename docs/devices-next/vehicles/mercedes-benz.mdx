...
| `region` |  | Standard: `EMEA`<br/>Auswahl: `EMEA`, `APAC`, `NORAM` | yes |
| `accessToken` |  |  | yes |
| `refreshToken` |  |  | yes |
| Vehicle Identification Number<br/>`vin` | If you own multiple vehicles from the same manufacturer | Beispiel: `V...` | no |
