...
<DeviceConfig
  code={`tariffs:
    grid:
      type: template
      template: epex-predictor
      region: DE # Region, [DE, AT, NL, BE, SE_1, SE_2, SE_3, SE_4, DK_1, DK_2]`}
  advanced={`tariffs:
    grid:
      type: template
      template: epex-predictor
  ...
  advanced={`tariffs:
    solar:
      - type: template
        ...
        rossmodel: 0.0342 # Kühlung [Ross-Modell], Gut Gekühlt (0.0200), Freistehend (0.0208), Flach auf Dach (0.0260), Nicht So Gut Gekühlt (0.0342), Transparentes PV (0.0455), Fassadenintegriert (0.0538), Auf Schrägdach (0.0563) [sciencedirect.com](https://www.sciencedirect.com/science/article/pii/S0038092X20309107) (optional)
        interval: 1h # Intervall, optional`}
/>
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/tariff  -->
  ...
  advanced={`tariffs:
    solar:
      - type: template
        ...
        forecast_days: 4 # Anzahl zusätzlicher Tage für die Prognose (1-6), Anzahl der zusätzlichen Tage für die Prognose (1-6), ohne den heutigen Tag. Bedenke: evcc berechnet die Energie für heute, morgen und übermorgen und verarbeitet dabei effektiv bis zu drei Tage Solarprognosedaten, zeigt jedoch bis zu 96 Stunden an. (optional)
        interval: 1h # Intervall, optional`}
/>
<!-- AUTO-GENERATED FROM TEMPLATE - PLEASE EDIT HERE https://github.com/evcc-io/evcc/tree/master/templates/definition/tariff  -->
