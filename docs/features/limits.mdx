...
Mit der Mindestladung kannst du pro Fahrzeug einen Wert definieren, auf den das Fahrzeug beim Anstecken möglichst schnell geladen werden soll.
...
Die Einstellung findest du im **Ankunft** Tab des **Ladeplanung** Dialogs am Ladepunkt.
...
Ist bspw. ein Ladeplan für "morgen 8 Uhr auf 100%" aktiv, würde dieser ein am Ladepunkt eingestelltes Limit von bspsw. 80% überschreiben.