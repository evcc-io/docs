...
**Wärmepumpen-Steuerung während der Reduzierung:**
SG-Ready Wärmepumpen werden automatisch in den reduzierten Betrieb versetzt.
Dies geschieht über die SG-Ready Schnittstelle ohne zusätzliche Konfiguration.
Weitere Informationen findest du unter [Wärmepumpen](../devices/heating).
