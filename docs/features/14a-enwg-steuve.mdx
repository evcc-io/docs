...
Alle Ladepunkte und sonstigen Verbraucher werden automatisch dem internen `lpc` Steuerstromkreis zugeordnet und bei einer externen Steueranforderung entsprechend reduziert.
...
Daher sind alle anderen untergeordneten Stromkreise (inkl. des Hauptstromkreises) mit ihren Ladepunkten und anderen Verbrauchern automatisch immer Teil des Steuerstromkreises.
Lokale Erzeugungsleistung erhöht das verfügbare Leistungsbudget im Steuerstromkreis.
:::
...
Dies betrifft z. B. Wärmepumpen oder Batteriespeicher, die über EEBus angebunden oder als Zähler mit Schaltausgang konfiguriert sind.
...
:::note Verbrauchersteuerung
Diese Funktion ist derzeit nur für EEBus-Zähler mit LPC implementiert.
