...
hems:
  ...
  limit: 
    source: modbus  # Details zu den Parametern stehen in der evcc-modbus Dokumentation 
    uri: 192.168.179.200:4703  # Beispiel für ein am 2. S-Zähler angeschlossenes Relais einer cfos Power Brain solar Wallbox
