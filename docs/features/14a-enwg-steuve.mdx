...
Ist [aktive Batteriesteuerung](./battery#aktive-batteriesteuerung) konfiguriert und ein Netzladevorgang der Hausbatterie aktiv, wird dieser automatisch pausiert.
