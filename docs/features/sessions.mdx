...
<Screenshot name="features/screenshots/sessions-main-ui" caption="Messwerte am Ladevorgang" />
...
<Screenshot name="features/screenshots/sessions-list" caption="Liste der Ladevorgänge eines Monats" />
...
<Screenshot name="features/screenshots/sessions-detail" caption="Detailansicht eines Ladevorgangs" />
