...
- [Netzladen](./battery#gridcharge) der Hausbatterie wird nicht berücksichtigt. Wenn die Hausbatterie aktiv aus dem Netz lädt, fließt dieser Verbrauch nicht in die Lastmanagement-Berechnung ein. Bei aktivem [§14a Reduzierungssignal](./14a-enwg-steuve) wird das Netzladen jedoch automatisch pausiert.
