...
Ist mehr Sonneneinstrahlung vorhanden, als die Hausbatterie aufnehmen kann, wird das angeschlossene Fahrzeugbereits bereits vor erreichen der eingestellten Grenze parallel geladen.
Ist kein Fahrzeug angeschlossen oder hat das Fahrzeug den vorgegebenen Ladestand erreicht, geht überschüssige Sonnenenergie natürlich weiterhin in die Hausbatterie.
