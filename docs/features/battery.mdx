...
Durch den Batterie Boost wird der PV-Modus maximal durch die Hausbatterie unterstützt. Zusätzlich zu der Energie aus der Photovoltaikananlage wird die maximal mögliche Leistung aus der Batterie gezogen. Das Boostverhalten endet, wenn das Auto abgesteckt wird oder der Modus umgeschaltet wird. 
