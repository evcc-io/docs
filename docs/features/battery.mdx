...
<Screenshot name="features/screenshots/battery-navigation" caption="Screenshot der Hauptnavigation." />

Hier stellst du ein, welcher Ladestand der Hausbatterie erreicht sein muss, bevor das Elektroauto geladen wird.
...
<Screenshot name="features/screenshots/battery-priority" caption="Priorität Haus und Auto" />
...
<Screenshot name="features/screenshots/battery-buffer" caption="Batterieunterstütztes Laden" />
...
<Screenshot name="features/screenshots/battery-bufferstart" caption="Automatischer Start" />
