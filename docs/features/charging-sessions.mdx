...
<Screenshot name="features/screenshots/charging-sessions-list" caption="Liste der Ladevorgänge eines Monats" />
...
<Screenshot name="features/screenshots/charging-sessions-detail" caption="Detailansicht eines Ladevorgangs" />
