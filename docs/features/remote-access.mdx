...
Remote Access setzt ein aktives [Sponsoring](/docs/sponsorship) voraus.
...
1. Setze auf dem Host, auf dem evcc läuft, die Umgebungsvariable:
   ...
   Unter Linux geschieht das über ein systemd-Drop-in mit `systemctl edit evcc`, siehe [Umgebungsvariablen & CLI-Optionen](/docs/installation/linux#environment).
...
4. Lege für jedes Gerät, das Zugriff bekommen soll, einen eigenen Client an.
   ...
   - **App:** Scanne den QR-Code mit der Kamera deines Smartphones.
     Die [evcc-App](/docs/features/app) öffnet sich und ist sofort verbunden.
