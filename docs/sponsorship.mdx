...
- **[Monatlich 2$](https://github.com/sponsors/evcc-io?frequency=recurring)**: Unterstütze das Projekt mit einem kleinen monatlichen Betrag.
...
- **[Einmalig 100$](https://github.com/sponsors/evcc-io?frequency=one-time)**: Für einen einmaligen Beitrag, erhältst du ein Sponsortoken mit unbegrenzter Gültigkeit.
