...
[![Michael auf Bank neben Go-e Wallbox](./michael-smartphone-go-e.webp)](/blog/2025/06/30/michael-vom-core-team)
...
Neben meinem Schwerpunkt der User Interface Entwicklung kümmere ich mich auch um unsere Außendarstellung.
...
Dann stieß ich auf evcc: minimalistisch, modular und mit Go und Vue.js ein spannender Tech-Stack.
...
![Michael vor Haus](./michael-vor-haus.webp)

## Das Ding mit dem Hundefutter

**Detlef:** Du hast selbst eine Installation am Laufen? Wie sieht die aus?
...
2023 haben wir dann alle Dachflächen vollgemacht: Carport und Nordseite bekamen auch Module, insgesamt sind es jetzt 18,8 kWp plus ein 12,8 kWh Hausspeicher.
...
Das ist nicht wirklich wirtschaftlich getrieben: Unsere Pelletsheizung würde das Wasser sogar etwas günstiger erwärmen, der E-Bike-Verbrauch ist im Vergleich zum Auto verschwindend gering.
...
| Komponente | Details |
|------------|---------|
| **PV-Anlage** | 18,8 kWp gesamt<br/>7,7 kWp Süd SolarEdge<br/>9,0 kWp Nord Sungrow<br/>2,1 kWp Carport Hoymiles & AhoyDTU |
...
Unser einheitliches Datenmodell sorgt dafür, dass der Zugriff auf Hausbatterien aller Modelle gleich funktioniert.
...
Viele Hersteller bieten proprietäre Systeme an, einige Wechselrichter öffnen sich.
Glaubst du, dass evcc außer bei IT-Freaks Begeisterung finden wird?
...
Ja, viele Hersteller integrieren inzwischen intelligente Ladefunktionen.
Das ist gut so - in einer idealen Welt sollte intelligenter Energieumgang so einfach wie möglich sein.
...
Zur Massenkompatibilität: Ja, heute braucht man noch technisches Wissen und etwas Technikliebe.
...
Cloud-Services sind natürlich immer komfortabler - anmelden, Zugangsdaten eingeben, fertig.
Aber dann bin ich abhängig und muss hoffen, dass verantwortungsvoll mit meinen Daten umgegangen wird und der Dienst immer stabil läuft.
Eine lokale Lösung in den eigenen vier Wänden gibt mir die volle Kontrolle.
Unabhängigkeit, Stabilität und Datenhoheit sind für mich und viele andere Nutzer ein wichtiges Kriterium.
...
Wir suchen vor allem fortgeschrittene Installationen oder Nutzer außerhalb Deutschlands.
