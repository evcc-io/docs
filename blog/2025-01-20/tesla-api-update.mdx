...
Für den evcc-Anwendungsfall sind nur die Tesla-Berechtigungen "Profilinformationen", "Fahrzeugdaten" und "Fahrzeugstandort" erforderlich.
...
Zusätzlich zu den oben genannten Berechtigungen wird für diese Funktion auch das Recht "Fahrzeug-Ladeverwaltung" benötigt.
