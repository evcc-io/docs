...
[![Gruppenbild vom evcc Community Treffen](./community-treffen-gruppenbild.webp)](/blog/2026/04/20/community-treffen-rueckblick)
...
- **Erweiterte Optimierung**: Zusammenspiel mit [EOS](https://github.com/Akkudoktor-EOS/EOS) (Projekt vom [Akkudoktor](https://akkudoktor.net)), [OpenEMS](https://openems.io), [Victron ESS](https://www.victronenergy.com/live/ess:start), [Home Assistant](https://www.home-assistant.io), dem in Entwicklung befindlichen [evcc Optimizer](/docs/features/optimizer) und Direktvermarktung.
...
Markus und Michael vom Osnabrücker Ruderverein haben mehrere Führungen durch die Energietechnik und die Bootshallen angeboten. Mehr zum Setup des Vereins gibt es im [Community Portrait](/blog/2025/11/29/osnabruecker-ruderverein).
